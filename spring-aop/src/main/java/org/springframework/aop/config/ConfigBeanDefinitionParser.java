...
class ConfigBeanDefinitionParser implements BeanDefinitionParser {
	...
	/**
	 * Configures the auto proxy creator needed to support the {@link org.springframework.beans.factory.config.BeanDefinition BeanDefinitions}
	...
	/**
	 * Create a {@link org.springframework.beans.factory.support.RootBeanDefinition} for the advisor described in the supplied. Does <strong>not</strong>
	...
	/**
	 * Creates a {@link org.springframework.beans.factory.config.BeanDefinition} for the {@link AspectJExpressionPointcut} class using
