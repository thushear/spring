...
/**
 * {@link org.springframework.beans.factory.parsing.ParseState} entry representing an advice element.
 * 
 * @author Mark Fisher
 * @since 2.0
 */
public class AdviceEntry implements ParseState.Entry {
	...
	/**
	 * Creates a new instance of the {@link org.springframework.aop.config.AdviceEntry} class.
