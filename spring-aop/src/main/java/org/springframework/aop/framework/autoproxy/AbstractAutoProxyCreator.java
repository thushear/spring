 ...
 *
 * <p>Any number of {@link org.springframework.aop.framework.autoproxy.TargetSourceCreator} implementations can be used to create
...
public abstract class AbstractAutoProxyCreator extends ProxyConfig
	 ...
	 * {@link org.springframework.aop.framework.autoproxy.AutoProxyUtils#PRESERVE_TARGET_CLASS_ATTRIBUTE "preserveTargetClass" attribute}
	 * of the corresponding bean definition.
	 * @param beanClass the class of the bean
	 * @param beanName the name of the bean
	 * @return whether the given bean should be proxied with its target class
	 * @see org.springframework.aop.framework.autoproxy.AutoProxyUtils#shouldProxyTargetClass
	 */
