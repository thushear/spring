 ...
 * singleton target, for example. See {@link org.springframework.aop.target.LazyInitTargetSource} and
 * {@link org.springframework.aop.target.AbstractPrototypeBasedTargetSource}'s subclasses for concrete strategies.
 *
 * <p>BeanFactory-based TargetSources are serializable. This involves
 * disconnecting the current target and turning into a {@link org.springframework.aop.target.SingletonTargetSource}.
 *
...
public abstract class AbstractBeanFactoryBasedTargetSource
	 ...
	 * provided by {@link org.springframework.aop.target.SingletonTargetSource}.
