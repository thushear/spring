...
public class JdkRegexpMethodPointcut extends AbstractRegexpMethodPointcut {
	...
	/**
	 * Initialize {@link java.util.regex.Pattern Patterns} from the supplied <code>String[]</code>.
	 */
	@Override
	...
	/**
	 * Initialize exclusion {@link java.util.regex.Pattern Patterns} from the supplied <code>String[]</code>.
	 */
	@Override
	...
	/**
	 * Returns <code>true</code> if the {@link java.util.regex.Pattern} at index <code>patternIndex</code>
	...
	/**
	 * Returns <code>true</code> if the exclusion {@link java.util.regex.Pattern} at index <code>patternIndex</code>
	 * matches the supplied candidate <code>String</code>.
	 */
	@Override
	 ...
	 * {@link java.util.regex.Pattern} objects and returns that array.
	 */
