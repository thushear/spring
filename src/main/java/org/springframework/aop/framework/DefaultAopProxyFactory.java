...
/**
 * Default {@link org.springframework.aop.framework.AopProxyFactory} implementation,
 * creating either a CGLIB proxy or a JDK dynamic proxy.
 *
 * <p>Creates a CGLIB proxy if one the following is true
 * for a given {@link org.springframework.aop.framework.AdvisedSupport} instance:
 * <ul>
 ...
 * @since 12.03.2004
 * @see org.springframework.aop.framework.AdvisedSupport#setOptimize
 * @see org.springframework.aop.framework.AdvisedSupport#setProxyTargetClass
 * @see org.springframework.aop.framework.AdvisedSupport#setInterfaces
 */
public class DefaultAopProxyFactory implements AopProxyFactory, Serializable {
	...
	/**
	 * Determine whether the supplied {@link org.springframework.aop.framework.AdvisedSupport} has only the
