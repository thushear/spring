...
/**
 * Listener to be registered on {@link org.springframework.aop.framework.ProxyCreatorSupport} objects
 * Allows for receiving callbacks on activation and change of advice.
 *
 * @author Rod Johnson
 * @author Juergen Hoeller
 * @see org.springframework.aop.framework.ProxyCreatorSupport#addListener
 */
