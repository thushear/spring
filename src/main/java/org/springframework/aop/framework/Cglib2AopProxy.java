...
/**
 * CGLIB2-based {@link org.springframework.aop.framework.AopProxy} implementation for the Spring AOP framework.
 *
 * <p><i>Requires CGLIB 2.1+ on the classpath.</i>.
 * As of Spring 2.0, earlier CGLIB versions are not supported anymore.
 *
 * <p>Objects of this type should be obtained through proxy factories,
 * configured by an {@link org.springframework.aop.framework.AdvisedSupport} object. This class is internal
...
final class Cglib2AopProxy implements AopProxy, Serializable {
	...
	/**
	 * Creates the CGLIB {@link net.sf.cglib.proxy.Enhancer}. Subclasses may wish to override this to return a custom
	 * {@link net.sf.cglib.proxy.Enhancer} implementation.
	 */
